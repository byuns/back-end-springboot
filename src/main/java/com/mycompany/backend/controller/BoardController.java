...
public class BoardController {
	...
	public ResponseEntity<InputStreamResource> download(@PathVariable int bno, HttpServletResponse response)  throws Exception{
		...
		String battachpath = "C:/Temp/uploadfiles/"+ battachsname;
		...
		FileInputStream fis = new FileInputStream(battachpath);
